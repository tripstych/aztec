		...
		public function update_plugins( $transient ) {
			...
			foreach ( $managed_plugins as $managed_plugin ) {
				...
				foreach ( $installed_plugins as $basename => $installed_plugin ) {
					...
					if ( 'jupiterx-core' === $managed_plugin->slug ) {
						$update->icons = [
							'2x' => esc_url( JUPITERX_ADMIN_ASSETS_URL . 'images/jupiterx-core-icon.png' ),
							'1x' => esc_url( JUPITERX_ADMIN_ASSETS_URL . 'images/jupiterx-core-icon.png' ),
						];
					}
