...
function jupiterx_portfolio_category_terms_choices() {
	if ( jupiterx_check_default() ) {
		return jupiterx_disable_default_get_terms( 'portfolio_category' );
	}
...
function jupiterx_category_terms_choices() {
	if ( jupiterx_check_default() ) {
		return jupiterx_disable_default_get_terms( 'category' );
	}
 ...
 */
function jupiterx_disable_default_get_terms( $taxonomy, $add_default = true ) {
