...
namespace Sellkit_Pro\Admin\Components\Analytics\Funnel;
 ...
 * @since 1.1.0
 */
class Upsell_Revenue extends Analytics_Base {
	...
	public function set_alert_details() {
		...
		$alerts = $wpdb->get_results(
			$wpdb->prepare( "SELECT FROM_UNIXTIME(applied_at, '%%b_%%d') as `day`, SUM(upsell_revenue) as total FROM {$funnel_table}
