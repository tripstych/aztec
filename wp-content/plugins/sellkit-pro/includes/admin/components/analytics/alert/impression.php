...
namespace Sellkit_Pro\Admin\Components\Analytics\Alert;
 ...
 * @since 1.1.0
 */
class Impression extends Analytics_Base {
	...
	public function set_alert_details() {
		...
		$alerts = $wpdb->get_results(
			$wpdb->prepare( "SELECT FROM_UNIXTIME(applied_at, '%%b_%%d') as `day`, SUM(impression) as total FROM {$alert_table}
