...
/**
 * Class Visitor's currency.
 *
 * @package Sellkit_Pro\Contact_Segmentation\Conditions
 * @since 1.1.0
 */
class Visitor_Currency extends Condition_Base {
	...
	public function get_title() {
		return __( 'Visitor\'s Local Currency', 'sellkit-pro' );
	}
	...
	public function get_options() {
		...
		return sellkit_filter_array( $currencies, $input_value );
	}
