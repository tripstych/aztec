...
if ( -1 !== window.JetEngineListingData.activeModules.indexOf( 'maps-listings' ) ) {
	...
	let paletteColors = settings.colors;

	const dynamicColorHelp = <>
		{ __(
		...
		</a><br/> If it returns an empty value or the value is not a color in HEX/RGBA/HSLA format - "Icon Color" will be used instead
	</>;
