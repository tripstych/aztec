	...
	protected function render() {
		...
		?><div <?php echo $this->get_render_attribute_string( 'instance' ); // phpcs:ignore ?>>
			...
			<div class="jet-switcher__content-wrapper"><?php
				...
				echo sprintf( '<div %1$s>%2$s</div>', $this->get_render_attribute_string( 'jet_switcher_content_disable' ), $disable_content_html ); // phpcs:ignore
				...
				echo sprintf( '<div %1$s>%2$s</div>', $this->get_render_attribute_string( 'jet_switcher_content_enable' ), $enable_content_html );// phpcs:ignore ?></div>
		</div>
		<?php
	}
