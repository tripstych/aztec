		...
		$this->_add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} ' . $css_scheme['jx_instance'] . ' .jx-controller i svg *' => 'fill: {{VALUE}}',
				),
			),
			25
		);
		...
		$this->_add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} ' . $css_scheme['jx_instance'] . ':hover .jx-controller i svg *' => 'fill: {{VALUE}}',
				),
			),
			25
		);
		...
		$this->_add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					...
					'{{WRAPPER}} ' . $css_scheme['jx_instance'] . ' .jx-controller i svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}',
				),
			),
			50
		);
