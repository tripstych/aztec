...
class Jet_Elements_Slider extends Jet_Elements_Base {
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'use_custom_content_alignments',
			array(
				'label'        => esc_html__( 'Use Custom Alignments', 'jet-elements' ),
		...
		$repeater->add_responsive_control(
			'slider_item_content_horizontal_alignment',
			array(
				'label'   => esc_html__( 'Content Horizontal Align', 'jet-elements' ),
				...
				'label_block' => 'true',
				'selectors'   => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} ' . $css_scheme['content_item'] => 'justify-content: {{VALUE}};',
				),
				'condition'   => array(
					'use_custom_content_alignments' => 'true',
				),
			)
		);

		$repeater->add_responsive_control(
			'slider_item_content_vertical_alignment',
			array(
				'label'   => esc_html__( 'Content Vertical Align', 'jet-elements' ),
				'type'    => Controls_Manager::CHOOSE,
				'options' => array(
					'flex-start' => array(
				...
				'label_block' => 'true',
				'selectors'   => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} '. $css_scheme['content_wrapper'] => 'justify-content: {{VALUE}};',
				),
				'condition'   => array(
					'use_custom_content_alignments' => 'true',
				),
		...
		$repeater->add_responsive_control(
			'slider_item_icon_box_alignment',
			array(
				'label'   => esc_html__( 'Icon Alignment', 'jet-elements' ),
				'type'    => Controls_Manager::CHOOSE,
				'default' => 'center',
				'options' => array(
					'flex-start' => array(
				...
				'label_block' => 'true',
				'selectors'   => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} ' . $css_scheme['icon'] => 'justify-content: {{VALUE}};',
				),
				'condition'   => array(
					'use_custom_content_alignments' => 'true',
				),
		...
		$repeater->add_responsive_control(
			'slider_item_title_alignment',
			array(
				'label'   => esc_html__( 'Title Text Alignment', 'jet-elements' ),
				'type'    => Controls_Manager::CHOOSE,
				'default' => 'center',
				'options' => array(
					'left'    => array(
				...
				'label_block' => 'true',
				'selectors'   => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} ' . $css_scheme['title'] => 'text-align: {{VALUE}};',
				),
				'condition'   => array(
					'use_custom_content_alignments' => 'true',
				),
		...
		$repeater->add_responsive_control(
			'slider_item_subtitle_alignment',
			array(
				'label'   => esc_html__( 'Subtitle Text Alignment', 'jet-elements' ),
				'type'    => Controls_Manager::CHOOSE,
				'default' => 'center',
				'options' => array(
					'left'    => array(
				...
				'label_block' => 'true',
				'selectors'   => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} ' . $css_scheme['subtitle'] => 'text-align: {{VALUE}};',
				),
				'condition'   => array(
					'use_custom_content_alignments' => 'true',
				),
		...
		$repeater->add_responsive_control(
			'slider_item_desc_container_alignment',
			array(
				'label'   => esc_html__( 'Description Alignment', 'jet-elements' ),
				'type'    => Controls_Manager::CHOOSE,
				'default' => 'center',
				'options' => array(
					'flex-start' => array(
				...
				'label_block' => 'true',
				'selectors'   => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} ' . $css_scheme['desc'] => 'align-self: {{VALUE}};',
				),
				'condition'   => array(
					'use_custom_content_alignments' => 'true',
				),
		...
		$repeater->add_responsive_control(
			'slider_item_desc_alignment',
			array(
				'label'   => esc_html__( 'Description Text Alignment', 'jet-elements' ),
				'type'    => Controls_Manager::CHOOSE,
				'default' => 'center',
				'options' => array(
					'left'    => array(
				...
				'label_block' => 'true',
				'selectors'   => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} ' . $css_scheme['desc'] => 'text-align: {{VALUE}};',
				),
				'condition'   => array(
					'use_custom_content_alignments' => 'true',
				),
		...
		$repeater->add_responsive_control(
			'slider_item_action_button_alignment',
			array(
				'label'   => esc_html__( 'Action Button Alignment', 'jet-elements' ),
				'type'    => Controls_Manager::CHOOSE,
				'default' => 'center',
				'options' => array(
					'left'    => array(
				...
				'label_block' => 'true',
				'selectors'   => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} ' . $css_scheme['buttons_wrapper'] => 'text-align: {{VALUE}};',
				),
				'condition'   => array(
					'use_custom_content_alignments' => 'true',
				),
	...
	public function generate_setting_json() {
		...
		$settings = array(
			...
			'fractionPrefix'   		=> $module_settings['fractionPrefix'],
			'fractionSeparator'		=> $module_settings['fractionSeparator'],
			'fractionSuffix'   		=> $module_settings['fractionSuffix'],
