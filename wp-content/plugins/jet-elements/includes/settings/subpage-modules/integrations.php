...
class Integrations extends Page_Module_Base {
	...
	public function get_page_slug() {
		return 'jet-elements-integrations-settings';
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['jet-elements-integrations-settings'] = jet_elements()->plugin_path( 'templates/admin-templates/integrations-settings.php' );
