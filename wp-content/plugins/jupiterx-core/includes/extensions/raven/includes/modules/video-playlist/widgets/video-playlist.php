<?php
namespace JupiterX_Core\Raven\Modules\Video_Playlist\Widgets;
...
class Video_Playlist extends Base_Widget {
	...
	public function get_name() {
		return 'raven-video-playlist';
	}

	public function get_title() {
		return esc_html__( 'Video Playlist', 'jupiterx-core' );
	}

	public function get_icon() {
		return 'raven-element-icon raven-element-icon-video-playlist';
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_playlist',
			[
				'label' => esc_html__( 'Playlist', 'jupiterx-core' ),
			]
		);
		...
		$this->add_control(
			'playlist_title',
			[
				'label' => esc_html__( 'Playlist Name', 'jupiterx-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Playlist', 'jupiterx-core' ),
				'placeholder' => esc_html__( 'Playlist', 'jupiterx-core' ),
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Paste URL', 'jupiterx-core' ) . ' (YouTube)',
				'label_block' => true,
				'condition' => [
					'type' => 'youtube',
				],
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' => true,
				'text' => esc_html__( 'Get Video Data', 'jupiterx-core' ),
				'separator' => 'none',
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Add Your Text Here', 'jupiterx-core' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Contents Tabs ', 'jupiterx-core' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$repeater->start_controls_tab(
			'inner_tab_1',
			[
				'label' => esc_html__( 'Tab #1', 'jupiterx-core' ),
				'condition' => [
					'type' => [ 'youtube', 'hosted', 'vimeo' ],
		...
		$repeater->add_control(
			...
			[
				...
				'default' => '<p>' . esc_html__( 'Add some content for each one of your videos, like a description, transcript or external links.To add, remove or edit tab names, go to Tabs.', 'jupiterx-core' ) . '</p>',
				'condition' => [
					'type' => [ 'youtube', 'hosted', 'vimeo' ],
					'inner_tab_is_content_visible' => 'show',
				],
		...
		$repeater->start_controls_tab(
			'inner_tab_2',
			[
				'label' => esc_html__( 'Tab #2', 'jupiterx-core' ),
				'condition' => [
					'type' => [ 'youtube', 'hosted', 'vimeo' ],
					'inner_tab_is_content_visible' => 'show',
				],
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Playlist Items', 'jupiterx-core' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'title' => esc_html__( 'Sample Video', 'jupiterx-core' ),
		...
		$this->add_control(
			'inner_tab_title_1',
			[
				'label' => esc_html__( 'Tab 1 Name', 'jupiterx-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Tab #1', 'jupiterx-core' ),
				'dynamic' => [
					'active' => true,
				],
				'ai' => [
				...
				'placeholder' => esc_html__( 'Name', 'jupiterx-core' ),
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'inner_tab_title_2',
			[
				'label' => esc_html__( 'Tab 2 Name', 'jupiterx-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Tab #2', 'jupiterx-core' ),
				'dynamic' => [
					'active' => true,
				],
				'ai' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Read More Label', 'jupiterx-core' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				...
				'placeholder' => esc_html__( 'Show More', 'jupiterx-core' ),
				'default' => esc_html__( 'Show More', 'jupiterx-core' ),
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Read Less Label', 'jupiterx-core' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				...
				'placeholder' => esc_html__( 'Show Less', 'jupiterx-core' ),
				'default' => esc_html__( 'Show Less', 'jupiterx-core' ),
				'condition' => [
					'inner_tab_is_content_collapsible' => 'collapsible',
				],
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .collapsible .raven-inner-tab-text' => 'height: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'inner_tab_is_content_collapsible' => 'collapsible',
				],
		...
		$this->add_control(
			'autoplay_on_load',
			[
				'label' => esc_html__( 'On Load', 'jupiterx-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'jupiterx-core' ),
				'label_off' => esc_html__( 'Hide', 'jupiterx-core' ),
				'frontend_available' => true,
		...
		$this->add_control(
			'autoplay_next',
			[
				'label' => esc_html__( 'Next Up', 'jupiterx-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'jupiterx-core' ),
				'label_off' => esc_html__( 'Hide', 'jupiterx-core' ),
				'frontend_available' => true,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Indicate Watched', 'jupiterx-core' ),
				'type' => Controls_Manager::SWITCHER,
				'separator' => 'before',
				'frontend_available' => true,
			]
		...
		$this->add_control(
			'show_video_count',
			[
				'label' => esc_html__( 'Video Count', 'jupiterx-core' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			'watched_icon',
			[
				'label' => esc_html__( 'Watched Icon', 'jupiterx-core' ),
				'type' => Controls_Manager::ICONS,
				'fa4compatibility' => 'icon',
				'default' => [
		...
		$this->add_control(
			'tabs_alignment',
			[
				'label' => esc_html__( 'Video Position', 'jupiterx-core' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .raven-tabs .raven-tabs-main-area' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Top Bar', 'jupiterx-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-header' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-header .raven-video-playlist-tabs-title' => 'color: {{VALUE}};',
				],
				'global' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-tabs-header .raven-video-playlist-tabs-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-header .raven-tabs-videos-count' => 'color: {{VALUE}};',
					'{{WRAPPER}} .raven-tabs-header .raven-tabs-header-right-side i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .raven-tabs-header .raven-tabs-header-right-side svg' => 'fill: {{VALUE}};',
				],
				'global' => [
					'default' => Global_Colors::COLOR_TEXT,
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-tabs-header .raven-tabs-videos-count',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Videos', 'jupiterx-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tab-title' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .raven-tabs-items-wrapper' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .raven-tabs-items-wrapper .shadow-bottom' => 'background: linear-gradient(180deg, transparent 0%, {{VALUE}} 100%)',
					'{{WRAPPER}} .raven-tabs-items-wrapper .shadow-top' => 'background: linear-gradient(0deg, transparent 0%, {{VALUE}} 100%);',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tab-title .raven-tab-title-text' => 'color: {{VALUE}};',
					'{{WRAPPER}} .raven-tab-title .raven-tab-title-text a' => 'color: {{VALUE}};',
				],
				'global' => [
					'default' => Global_Colors::COLOR_TEXT,
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-tab-title .raven-tab-title-text',
				'global' => [
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tab-title .raven-tab-duration' => 'color: {{VALUE}};',
				],
				'global' => [
					'default' => Global_Colors::COLOR_TEXT,
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-tab-title .raven-tab-duration',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tab-title i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .raven-tab-title svg' => 'fill: {{VALUE}};',
					'{{WRAPPER}} .raven-tab-title svg path' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'fields_options' => [
					...
					'text_shadow' => [
						'selectors' => [
							'{{WRAPPER}} .raven-tab-title i' => 'text-shadow: {{HORIZONTAL}}px {{VERTICAL}}px {{BLUR}}px {{COLOR}};',
							'{{WRAPPER}} .raven-tab-title svg' => 'filter: drop-shadow({{HORIZONTAL}}px {{VERTICAL}}px {{BLUR}}px {{COLOR}});',
						],
					],
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .raven-tab-title' => 'border-style: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .raven-tab-title' => 'border-width: 0 0 {{SIZE}}{{UNIT}} 0;',
				],
				'condition' => [
					'normal_separator_style!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tab-title' => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'normal_separator_style!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-items-wrapper .raven-tabs-items .raven-tab-title:where( .e-active, :hover )' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#556068',
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-items-wrapper .raven-tab-title:where( .e-active, :hover ) .raven-tab-title-text' => 'color: {{VALUE}};',
					'{{WRAPPER}} .raven-tabs-items-wrapper .raven-tab-title:where( .e-active, :hover ) .raven-tab-title-text a' => 'color: {{VALUE}};',
				],
				'global' => [
					'default' => Global_Colors::COLOR_TEXT,
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-tabs-items-wrapper .raven-tab-title:where( .e-active, :hover ) .raven-tab-title-text',
				'global' => [
					'default' => Global_Typography::TYPOGRAPHY_TEXT,
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-items-wrapper .raven-tab-title:where( .e-active, :hover ) .raven-tab-duration' => 'color: {{VALUE}};',
				],
				'global' => [
					'default' => Global_Colors::COLOR_TEXT,
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-tabs-items-wrapper .raven-tab-title:where( .e-active, :hover ) .raven-tab-duration',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-items-wrapper .raven-tab-title:where( .e-active, :hover ) i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .raven-tabs-items-wrapper .raven-tab-title:where( .e-active, :hover ) svg' => 'color: {{VALUE}};',
					'{{WRAPPER}} .raven-tabs-items-wrapper .raven-tab-title:where( .e-active, :hover ) svg path' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-tab-title:where( .e-active, :hover ) i, {{WRAPPER}} .raven-tab-title:where( .e-active, :hover ) svg',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .raven-tab-title:where( .e-active, :hover ) span i' => 'font-size: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .raven-tab-title:where( .e-active, :hover ) span svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-items-wrapper .raven-tab-title.e-active' => 'border-style: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-items-wrapper .raven-tab-title.e-active' => 'border-width: 0 0 {{SIZE}}{{UNIT}} 0;',
				],
				'condition' => [
					'active_separator_style!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-items-wrapper .raven-tabs-items .raven-tab-title.e-active' => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'active_separator_style!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-items-wrapper .e-section-title' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-items-wrapper .e-section-title' => 'color: {{VALUE}};',
				],
				'global' => [
					'default' => Global_Colors::COLOR_TEXT,
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-tabs-items-wrapper .e-section-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-items-wrapper .e-section-title' => 'border-style: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-items-wrapper .e-section-title' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-items-wrapper .e-section-title' => 'border-color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper' => '--inner-tabs-border-height: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-title.raven-inner-tab-active' => 'border-width: 0 0 {{SIZE}}{{UNIT}} 0;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper' => '--inner-tabs-border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-active' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-inner-tab-content' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-inner-tab-title' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-title a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-title.raven-inner-tab-active a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-title.raven-inner-tab-active' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'fields_options' => [
					'font_family' => [
						'selectors' => [
							'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-tab-mobile-title' => 'font-family: {{VALUE}};',
							'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-title a' => 'font-family: {{VALUE}};',
						],
					],
					'font_size' => [
						'selectors' => [
							'(mobile){{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-tab-mobile-title' => 'font-size: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-title a' => 'font-size: {{SIZE}}{{UNIT}};',
						],
					],
					'font_weight' => [
						'selectors' => [
							'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-tab-mobile-title' => 'font-weight: {{VALUE}};',
							'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-title a' => 'font-weight: {{VALUE}};',
						],
					],
					'text_transform' => [
						'selectors' => [
							'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-tab-mobile-title' => 'text-transform: {{VALUE}};',
							'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-title a' => 'text-transform: {{VALUE}};',
						],
					],
					'font_style' => [
						'selectors' => [
							'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-tab-mobile-title' => 'font-style: {{VALUE}};',
							'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-title a' => 'font-style: {{VALUE}};',
						],
					],
					'text_decoration' => [
						'selectors' => [
							'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-tab-mobile-title' => 'text-decoration: {{VALUE}};',
							'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-title a' => 'text-decoration: {{VALUE}};',
						],
					],
					'line_height' => [
						'selectors' => [
							'(mobile){{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-tab-mobile-title' => 'line-height: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-title a' => 'line-height: {{SIZE}}{{UNIT}};',
						],
					],
					'letter_spacing' => [
						'selectors' => [
							'(mobile){{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-tab-mobile-title' => 'letter-spacing: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-title a' => 'letter-spacing: {{SIZE}}{{UNIT}};',
						],
					],
					'word_spacing' => [
						'selectors' => [
							'(mobile){{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-tab-mobile-title' => 'word-spacing: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-title a' => 'word-spacing: {{SIZE}}{{UNIT}};',
						],
					],
					'selector' => '{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-wrapper .raven-inner-tab-title a',
				],
				'global' => [
					'default' => Global_Typography::TYPOGRAPHY_TEXT,
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-inner-tab-content .raven-inner-tab-text' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-inner-tab-content .raven-inner-tab-text',
				'global' => [
					'default' => Global_Typography::TYPOGRAPHY_TEXT,
				],
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-inner-tab-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Show More', 'jupiterx-core' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-inner-tab-content button' => 'color: {{VALUE}};',
				],
				'global' => [
					'default' => Global_Colors::COLOR_TEXT,
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-inner-tab-content button:hover' => 'color: {{VALUE}};',
				],
				'global' => [
					'default' => Global_Colors::COLOR_TEXT,
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-inner-tab-content button' => 'transition-duration: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-tabs-inner-tabs .raven-inner-tabs-content-wrapper .raven-inner-tab-content button',
				'global' => [
	...
	/**
	 * Creates an array of playlist item tabs for a given playlist item.
	 *
	 * @param array $playlist_item The playlist item data.
	 * @param int $playlist_item_index The index of the playlist item.
	 * @param string $tab_1_title The title for the first tab.
	 * @param string $tab_2_title The title for the second tab.
	 *
	 * @return array An array of playlist item tabs.
	 */
	private function create_playlist_item_tabs_array( $playlist_item, $playlist_item_index, $tab_1_title, $tab_2_title ) {
		...
		foreach ( $playlist_item_tabs_content as $index => $playlist_item_tab_content ) {
			...
			if ( $playlist_item_tab_content ) {
				...
				$playlist_item_tab_content_object->tab_class     = ! $is_already_activated_tab ? 'raven-inner-tab-active' : '';
	...
	/**
	 * Creates HTML attributes object for a playlist item video content.
	 *
	 * @param int $index The index of the playlist item.
	 * @param int $id_int The unique ID for the playlist item.
	 * @param array $playlist_item The playlist item data.
	 * @param string $video_url The URL of the video (optional).
	 *
	 * @return \stdClass The HTML attributes object.
	 */
	private function create_playlist_item_video_attributes( $index, $id_int, $playlist_item, $video_url = '' ) {
		...
		$html_attributes_object->attributes = [
			'id' => 'raven-tab-content-' . $id_int . $tab_count,
			'class' => [ 'raven-tab-content', 'elementor-clearfix' ],
			'data-tab' => $tab_count,
			'role' => 'tabpanel',
			'aria-labelledby' => 'raven-tab-title-' . $id_int . $tab_count,
			'tabindex' => '0',
	...
	/**
	 * Creates HTML attributes object for a playlist item title.
	 *
	 * @param int $index The index of the playlist item.
	 * @param int $id_int The unique ID for the playlist item.
	 *
	...
	private function create_playlist_item_title_attributes( $index, $id_int ) {
		...
		$html_attributes_object->attributes = [
			'id' => 'raven-tab-title-' . $id_int . $tab_count,
			'class' => [ 'raven-tab-title', 'raven-tab-desktop-title' ],
			'aria-selected' => 1 === $tab_count ? 'true' : 'false',
			'data-tab' => $tab_count,
			'role' => 'tab',
			'tabindex' => 1 === $tab_count ? '0' : '-1',
			'aria-controls' => 'raven-tab-content-' . $id_int . $tab_count,
		];
	...
	/**
	 * Creates an array of playlist items based on the provided data.
	 *
	 * @param array $playlist_items An array of playlist item data.
	 *
	...
	private function create_playlist_items_array( $playlist_items ) {
		...
		foreach ( $playlist_items as $index => $playlist_item ) {
			...
			$type = $this->get_video_type( $playlist_item['type'] );

			if ( 'youtube' === $type || 'vimeo' === $type || 'hosted' === $type ) {
				$type = 'videos';
			}

			$method_name = "update_playlist_item_object_$type";

			if ( method_exists( $this, $method_name ) ) {
				$playlist_item_object = $this->$method_name( $playlist_item_object, $playlist_item, $index, $id_int );
			}
	...
	/**
	 * Determine the video type based on the playlist item type.
	 *
	 * @param string $type The playlist item type.
	 *
	 * @return string The determined video type ('section' or 'hosted').
	 */
	private function get_video_type( $type ) {
		if ( 'section' === $type ) {
			return 'section';
		}
	...
	/**
	 * Updates a playlist item object with provided data.
	 *
	 * @param \stdClass $playlist_item_object The playlist item object to be updated.
	 * @param array $playlist_item The playlist item data to update the object.
	 *
	 * @return \stdClass The updated playlist item object.
	 *
	 * @SuppressWarnings(PHPMD.NPathComplexity)
	 * @SuppressWarnings(PHPMD.UnusedPrivateMethod)
	 */
	private function update_playlist_item_object_videos( $playlist_item_object, $playlist_item, $index, $id_int ) {
		...
		$playlist_item_object->video_url = $this->get_video_url( $playlist_item );
		...
		if ( $this->get_settings_for_display( 'show_thumbnail' ) ) {
			// WPML compatibility.
			$playlist_item['thumbnail']['id'] = apply_filters( 'wpml_object_id', $playlist_item['thumbnail']['id'], 'attachment', true );

			if ( ! empty( $playlist_item['thumbnail']['id'] ) ) {
				$attachment_url = wp_get_attachment_image_src( $playlist_item['thumbnail']['id'], 'full' );

				if ( $attachment_url ) {
					$playlist_item['thumbnail']['url'] = $attachment_url[0];
				}
			}
		...
		return $playlist_item_object;
	}

	/**
	 * Determine the video URL based on the playlist item.
	 *
	 * @param array $playlist_item The playlist item data.
	 *
	 * @return string|null The determined video URL or null if not found.
	 */
	private function get_video_url( $playlist_item ) {
		if ( $playlist_item['youtube_url'] && 'youtube' === $playlist_item['type'] ) {
			return $playlist_item['youtube_url'];
		}

		if ( $playlist_item['vimeo_url'] && 'vimeo' === $playlist_item['type'] ) {
			return $playlist_item['vimeo_url'];
		}

		if ( $playlist_item['external_url'] && 'hosted' === $playlist_item['type'] && 'yes' === $playlist_item['is_external_url'] ) {
			return $playlist_item['external_url']['url'];
		}

		if ( $playlist_item['hosted_url'] && 'hosted' === $playlist_item['type'] && 'yes' !== $playlist_item['is_external_url'] ) {
			// WPML Compatibility.
			$playlist_item['hosted_url']['id']  = apply_filters( 'wpml_object_id', $playlist_item['hosted_url']['id'], 'attachment', true );
			$playlist_item['hosted_url']['url'] = wp_get_attachment_url( $playlist_item['hosted_url']['id'] );

			return $playlist_item['hosted_url']['url'];
		}
	}

	/**
	 * Updates a playlist item object for a section with provided data.
	 *
	 * @param \stdClass $playlist_item_object The playlist item object to be updated.
	 * @param array $playlist_item The playlist item data to update the object.
	 *
	 ...
	 * @SuppressWarnings(PHPMD.UnusedPrivateMethod)
	 */
	private function update_playlist_item_object_section( $playlist_item_object, $playlist_item ) {
		$playlist_item_object->type             = $playlist_item['type'];
	...
	/**
	 * Counts the number of video items in the playlist items array.
	 *
	 * @param array $playlist_items An array of playlist items.
	 *
	 * @return int The count of video items in the playlist.
	 */
	...
	private function prepare_video_playlist_data_object() {
		...
		if ( ! empty( $image_overlay['url'] ) ) {
			// WPML compatibility.
			$image_overlay['id'] = apply_filters( 'wpml_object_id', $image_overlay['id'], 'attachment', true );

			if ( ! empty( $image_overlay['id'] ) ) {
				$attachment_url = wp_get_attachment_image_src( $image_overlay['id'], 'full' );

				if ( $attachment_url ) {
					$image_overlay['url'] = $attachment_url[0];
				}
			}
			...
			if ( is_array( $playlist_object->image_overlay_image ) && ! empty( $playlist_object->image_overlay_image[1] ) ) {
				$playlist_object->image_overlay_image = $playlist_object->image_overlay_image[1];
			} else {
	...
	protected function render() {
		...
		<div class="raven-tabs">
			<div class="raven-tabs-main-area">
				<div class="raven-tabs-wrapper">
					<div class="raven-tabs-header">
						<<?php Utils::print_validated_html_tag( $playlist_object->playlist_title_tag ); ?> class="raven-video-playlist-tabs-title"><?php
							echo esc_html( $playlist_object->playlist_name );
						?></<?php Utils::print_validated_html_tag( $playlist_object->playlist_title_tag ); ?>>
						<div class="raven-tabs-header-right-side">
							<?php if ( $playlist_object->is_show_video_count ) : ?>
								<span class="raven-tabs-videos-count"><?php echo esc_attr( $playlist_object->video_count ); ?> <?php echo esc_html__( 'Videos', 'jupiterx-core' ); ?></span>
							<?php endif; ?>
							<?php
					...
					<div class="raven-tabs-items-wrapper">
						<div class="raven-tabs-items" role="tablist">
							<?php
							foreach ( $playlist_object->playlist_items as $item ) : ?>
								<?php if ( 'section' === $item->type ) : ?>
									<<?php Utils::print_validated_html_tag( $item->section_html_tag ); ?> class="e-section-title"><?php
										echo esc_html( $item->section_title );
								...
								<?php else : ?>
									<div <?php Utils::print_html_attributes( $item->html_attributes_title->attributes ); ?>>
										...
										<?php else : ?>
											...
											<span class="icon-watched"><?php Icons_Manager::render_icon( $playlist_object->watched_icon, [ 'aria-hidden' => 'true' ] ); ?></span>
										<?php endif; ?>
										<<?php Utils::print_validated_html_tag( $item->video_html_tag ); ?> class="raven-tab-title-text">
											<a tabindex="0"><?php
												echo esc_html( $item->video_title );
											?></a>
										</<?php Utils::print_validated_html_tag( $item->video_html_tag ); ?>>
										<?php if ( $item->video_duration ) : ?>
											<span class="raven-tab-duration"><?php echo esc_html( $item->video_duration ); ?></span>
										<?php endif; ?>
									</div>
								<?php endif; ?>
							<?php endforeach; ?>
				...
				<div class="raven-tabs-content-wrapper" role="tablist" aria-orientation="vertical">
					<?php foreach ( $playlist_object->playlist_items as $item ) : ?>
						<div <?php Utils::print_html_attributes( $item->html_attributes_video->attributes ); ?>>
							...
							<?php if ( $item->show_overlay_image ) : ?>
								<div class="raven-custom-embed-image-overlay elementor-clickable" style="background-image: url('<?php echo esc_url( $playlist_object->image_overlay_image ); ?>');">
									<?php if ( ! empty( $playlist_object->image_overlay_icon['value'] ) ) : ?>
										<div class="elementor-custom-embed-play" role="button">
											...
											<span class="elementor-screen-only"><?php echo esc_html__( 'Play Video', 'jupiterx-core' ); ?></span>
										</div>
									<?php endif; ?>
								</div>
							<?php endif; ?>
			...
			<div class="raven-tabs-inner-tabs" >
				<?php foreach ( $playlist_object->playlist_items as $item ) : ?>
					<?php if ( $item->is_inner_tabs_visible ) : ?>
						<div <?php Utils::print_html_attributes( $item->html_attributes_video->attributes ); ?>>
							<?php if ( count( $item->tabs ) > 0 ) : ?>
								<div class="raven-inner-tabs-wrapper">
									<?php foreach ( $item->tabs as $tab ) :
										if ( $tab->tab_content ) { ?>
											<div class="raven-inner-tab-title <?php Utils::print_unescaped_internal_string( $tab->tab_class ); ?>">
												<a class="raven-inner-tab-title-text" tabindex="0"><?php Utils::print_unescaped_internal_string( $tab->tab_title ); ?></a>
											</div>
										<?php } ?>
									<?php endforeach; ?>
								</div>
								<div class="raven-inner-tabs-content-wrapper">
									<?php foreach ( $item->tabs as $tab ) :
										if ( $tab->tab_content ) { ?>
											<div class="raven-inner-tab-title raven-tab-mobile-title <?php Utils::print_unescaped_internal_string( $tab->tab_class ); ?>">
												<?php echo esc_html( $tab->tab_title ); ?>
											</div>
											<div <?php Utils::print_unescaped_internal_string( $tab->tab_attribute ); ?> class="raven-inner-tab-content <?php Utils::print_unescaped_internal_string( $tab->tab_class ); ?> <?php echo esc_attr( $item->tab_collapsible ); ?>">
												<div class="raven-inner-tab-text">
												...
												<div class="raven-inner-tab-buttons">
													<button class="show-button"><?php echo esc_html( $item->read_more_label ); ?></button>
													<button><?php echo esc_html( $item->read_less_label ); ?></button>
												</div>
											</div>
										<?php } ?>
									<?php endforeach; ?>
		...
		<?php
		// phpcs:enable Squiz.PHP.EmbeddedPhp.ContentAfterEnd, Squiz.PHP.EmbeddedPhp.ContentBeforeOpen
	}
	...
	protected function content_template() {
		...
		function createPlaylistItemTabsArray( playlistItem, playlistItemIndex, tab1Title, tab2Title ) {
			...
			playlistItemTabsContent.forEach( function( playlistItemTabContent, index ) {
				...
				if ( playlistItemTabContent ) {
					...
					playlistItemTabContentObject.tabClass = ! isAlreadyActivatedTab ? 'raven-inner-tab-active' : '';
		...
		function createPlaylistItemVideoAttributes( index, id, playlistItem, videoUrl ) {
			...
			htmlAttributesObject.attributes = {
				'id' : 'raven-tab-content-' + id + tabCount,
				'class' : [ 'raven-tab-content', 'elementor-clearfix' ],
				'data-tab' : tabCount,
				'role' : 'tabpanel',
				'aria-labelledby' : 'raven-tab-title-' + id + tabCount,
				'tabindex' : '0',
		...
		function createPlaylistItemTitleAttributes( index, id ) {
			...
			htmlAttributesObject.attributes = {
				'id' : 'raven-tab-title-' + id + tabCount,
				'class' : [ 'raven-tab-title', 'raven-tab-desktop-title' ],
				'aria-selected' : 1 === tabCount ? 'true' : 'false',
				'data-tab' : tabCount,
				'role' : 'tab',
				'tabindex' : 1 === tabCount ? '0' : '-1',
				'aria-controls' : 'raven-tab-content-' + id + tabCount,
			};
		...
		#>
		<div class="raven-tabs" role="tablist" aria-orientation="vertical">
			<div class="raven-tabs-main-area">
				<div class="raven-tabs-wrapper">
					<div class="raven-tabs-header">
						<{{ playlistObject.playlistNameHTMLTag }} class="raven-video-playlist-tabs-title">
							{{{ playlistObject.playlistName }}}
						</{{ playlistObject.playlistNameHTMLTag }}>
						<div class="raven-tabs-header-right-side">
							<# if ( playlistObject.isShowVideoCount ) { #>
								<span class="raven-tabs-videos-count">{{{ playlistObject.videoCount }}} Videos</span>
							<# } #>
							<i class="raven-tabs-toggle-videos-display-button eicon-caret-down rotate-down" aria-hidden="true"></i>
						</div>
					</div>
					<div class="raven-tabs-items-wrapper">
						<div class="raven-tabs-items" role="tablist">
							<# _.each( playlistObject.playlistItems, function( item, index ) { #>
								...
								<# } else { #>
									...
									<div {{{ view.getRenderAttributeString( tabTitleKey ) }}}>
										...
										<span class="icon-watched">{{{ watchedIconHTML.value }}}</span>
										<# } #>
										<{{ item.videoHtmlTag }} class="raven-tab-title-text">
											<a tabindex="0">{{{ item.videoTitle }}}</a>
										</{{ item.videoHtmlTag }}>
										<# if ( item.videoDuration ) { #>
										<span class="raven-tab-duration">{{{ item.videoDuration }}}</span>
										<# } #>
									</div>
								<# } #>
							<# } ); #>
				...
				<div class="raven-tabs-content-wrapper">
					<# _.each( playlistObject.playlistItems, function( item, index ) { #>
					<div class="raven-tab-title raven-tab-mobile-title" role="tab">{{{ item.title }}}</div>
					<#
					...
					<div {{{ view.getRenderAttributeString( tabContentKey ) }}}>
						...
						<div class="raven-custom-embed-image-overlay elementor-clickable" style="background-image: url( {{ playlistObject.imageOverlayImage }} );">
							...
							<# if ( item.tabs.length > 0 ) { #>
								<div class="raven-inner-tabs-wrapper">
									<# _.each( item.tabs, function( tab ) { #>
										<# if ( tab.tab_content ) { #>
											<div class="raven-inner-tab-title {{{ tab.tabClass }}}">
												<a class="raven-inner-tab-title-text" tabindex="0"> {{{ tab.tab_title }}} </a>
											</div>
										<# } #>
									<# }); #>
								</div>
								<div class="raven-inner-tabs-content-wrapper">
									<# _.each( item.tabs, function( tab ) { #>
										<div class="raven-inner-tab-title raven-tab-mobile-title {{{ tab.tabClass }}}">
											{{{ tab.tab_title }}}
										</div>
										<div {{{ tab.tabAttribute }}} class="raven-inner-tab-content {{{ tab.tabClass }}} {{{ item.tabCollapsible }}}">
											<div class="raven-inner-tab-text">
