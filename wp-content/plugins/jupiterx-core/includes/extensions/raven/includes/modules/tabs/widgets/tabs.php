		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.raven-advanced-tab-icon-position-top .raven-tabs .raven-tabs-content-wrapper .raven-tabs-title' => 'align-items: {{VALUE}};',
					'{{WRAPPER}}.raven-advanced-tab-icon-position-top .raven-tabs .raven-tabs-list .raven-tabs-title' => 'align-items: {{VALUE}};',
				],
			]
		);
	...
	private function register_styles_ative_tab() {
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'raven-advanced-tab-icon-position-',
				'selectors' => [
