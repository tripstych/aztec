...
class Module extends Module_Base {
	...
	public function modify_single_query() {
		...
		add_filter( 'jupiterx_preview_settings_applied_editor_mode', '__return_true' );
		add_filter( 'jupiterx_preview_settings_applied_post', function() use ( $id ) {
			return $id;
		} );
	...
	private function raven_post_arguments( $settings ) {
		...
		$general = apply_filters(
			'jupiterx_raven_preview_settings_valid_template_types',
			[
				'header',
				'footer',
				'page-title-bar',
