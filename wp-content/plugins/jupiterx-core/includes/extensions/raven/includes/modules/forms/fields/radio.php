...
class Radio extends Field_Base {
	...
	public function render_content() {
		...
		foreach ( $options as $key => $option ) {
			...
			$html .= '<span class="raven-field-option"><input ' . $this->widget->get_render_attribute_string( $element_id ) . '  class="raven-field"> <label for="' . esc_attr( $html_id ) . '" class="raven-field-label raven-field-option-label">' . wp_kses_post( $option_label ) . '</label></span>';
		}
