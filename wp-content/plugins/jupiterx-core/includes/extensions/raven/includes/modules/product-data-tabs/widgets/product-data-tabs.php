	...
	public function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '#111111',
				'selectors' => [
					'{{WRAPPER}} .raven-product-data-tabs .woocommerce-tabs .woocommerce-Tabs-panel h1:not(.elementor-heading-title)' => 'color: {{VALUE}};',
					'{{WRAPPER}} .raven-product-data-tabs .woocommerce-tabs .woocommerce-Tabs-panel h2:not(.elementor-heading-title)' => 'color: {{VALUE}};',
					'{{WRAPPER}} .raven-product-data-tabs .woocommerce-tabs .woocommerce-Tabs-panel h3:not(.elementor-heading-title)' => 'color: {{VALUE}};',
					'{{WRAPPER}} .raven-product-data-tabs .woocommerce-tabs .woocommerce-Tabs-panel h4:not(.elementor-heading-title)' => 'color: {{VALUE}};',
					'{{WRAPPER}} .raven-product-data-tabs .woocommerce-tabs .woocommerce-Tabs-panel h5:not(.elementor-heading-title)' => 'color: {{VALUE}};',
					'{{WRAPPER}} .raven-product-data-tabs .woocommerce-tabs .woocommerce-Tabs-panel h6:not(.elementor-heading-title)' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-product-data-tabs .woocommerce-tabs .woocommerce-Tabs-panel h1:not(.elementor-heading-title):not(.raven-heading), {{WRAPPER}} .raven-product-data-tabs .woocommerce-tabs .woocommerce-Tabs-panel h2:not(.elementor-heading-title):not(.raven-heading), {{WRAPPER}} .raven-product-data-tabs .woocommerce-tabs .woocommerce-Tabs-panel h3:not(.elementor-heading-title):not(.raven-heading), {{WRAPPER}} .raven-product-data-tabs .woocommerce-tabs .woocommerce-Tabs-panel h4:not(.elementor-heading-title):not(.raven-heading), {{WRAPPER}} .raven-product-data-tabs .woocommerce-tabs .woocommerce-Tabs-panel h5:not(.elementor-heading-title):not(.raven-heading), {{WRAPPER}} .raven-product-data-tabs .woocommerce-tabs .woocommerce-Tabs-panel h6:not(.elementor-heading-title):not(.raven-heading)',
			]
		);
