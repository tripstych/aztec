		...
		$widget->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .woocommerce-MyAccount-content .woocommerce-EditAccountForm .button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	public static function add_section_tables( Base_Widget $widget ) {
		...
		$widget->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-pagination .button' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-orders-table__cell-order-actions .button' => 'color: {{VALUE}} !important;',
				],
			]
		);
		...
		$widget->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .shop_table .button, {{WRAPPER}} .order-again .button, {{WRAPPER}} .woocommerce-pagination .button, {{WRAPPER}} .raven-my-account-tab__orders .woocommerce-pagination .button, {{WRAPPER}} .raven-my-account-tab__orders .woocommerce-orders-table__cell-order-actions .button',
			]
		);
		...
		$widget->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-pagination .button:hover' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-orders-table__cell-order-actions .button:hover' => 'color: {{VALUE}} !important;',
				],
			]
		);
		...
		$widget->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .shop_table .button:hover, {{WRAPPER}} .order-again .button:hover, {{WRAPPER}} .woocommerce-pagination .button:hover, {{WRAPPER}} .raven-my-account-tab__orders .woocommerce-pagination .button:hover, {{WRAPPER}} .raven-my-account-tab__orders .woocommerce-orders-table__cell-order-actions .button:hover',
			]
		);
		...
		$widget->add_control(
			...
			[
				...
				'type'      => 'color',
				'selectors' => [
					'{{WRAPPER}} .shop_table .button:hover, {{WRAPPER}} .order-again .button:hover, {{WRAPPER}} .woocommerce-pagination .button:hover, {{WRAPPER}} .raven-my-account-tab__orders .woocommerce-pagination .button:hover' => 'border-color: {{VALUE}};',
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-pagination .button:hover' => 'border-color: {{VALUE}} !important;',
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-orders-table__cell-order-actions .button:hover' => 'border-color: {{VALUE}} !important;',
				],
				'condition' => [
		...
		$widget->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-pagination .button' => 'border-style: {{VALUE}} !important;',
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-orders-table__cell-order-actions .button' => 'border-style: {{VALUE}} !important;',
				],
				'separator' => 'before',
			]
		);
		...
		$widget->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-pagination .button' => 'border-color: {{VALUE}} !important;',
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-orders-table__cell-order-actions .button' => 'border-color: {{VALUE}} !important;',
				],
				'condition' => [
					'tables_button_border_type!' => 'none',
				],
		...
		$widget->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-orders-table__cell-order-actions .button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
				],
			]
		);
		...
		$widget->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-orders-table__cell-order-actions .button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-pagination .button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);

		$widget->add_responsive_control(
			'tables_button_normal_margin',
			[
				'label'      => esc_html__( 'Margin', 'jupiterx-core' ),
				'type'       => 'dimensions',
				'size_units' => [ 'px', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-orders-table__cell-order-actions .button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .raven-my-account-tab__orders .woocommerce-pagination .button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
