	...
	public function render() {
		...
		<form class="raven-search-form raven-search-form-full" method="get" action="<?php echo esc_url( $this->parent->form_home_url() ); ?>" role="search">
			<div class="raven-search-form-container">
				...
				if ( $is_new || $migrated ) {
					if (
						'svg' === $icon_new['library'] ||
						in_array( get_option( 'elementor_experiment-e_font_icon_svg', 'default' ), [ 'active', 'default' ], true )
					) {
						?>
			...
			<div class="raven-search-form-lightbox">
				...
				<input id="raven-search-form-input" class="raven-search-form-input" type="search" name="s" placeholder="<?php echo esc_attr( $this->parent->get_settings_for_display( 'placeholder' ) ); ?>" />
			</div>
