...
namespace JupiterX_Core\Raven\Modules\Site_Title\Widgets;
...
class Site_Title extends Base_Widget {

	public function get_name() {
		return 'raven-site-title';
	}

	public function get_title() {
		return esc_html__( 'Site Title', 'jupiterx-core' );
	}

	public function get_icon() {
		return 'raven-element-icon raven-element-icon-site-title';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '#1890ff',
				'selectors' => [
					'{{WRAPPER}} .raven-site-title' => 'color: {{VALUE}};',
					'{{WRAPPER}} .raven-site-title a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'typography',
				'selector' => '{{WRAPPER}} .raven-site-title, {{WRAPPER}} .raven-site-title a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .raven-site-title' => 'mix-blend-mode: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'title', 'class', 'raven-site-title' );
