...
class Content_Switch extends Base_Widget {
	...
	protected function render() {
		...
		?>
		<div class="raven-content-switch-container" data-default_state="<?php echo esc_attr( $default_state ); ?>">
					...
					<li data-type="raven-content-switch-monthly"
						...
						<?php if ( 'content' === $settings['primary_content_type'] ) : ?>
							...
							<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'primary_text_content' ) ); ?>>
								<?php $this->print_text_editor( $settings['primary_text_content'] ); ?>
							</div>
					...
					<li data-type="raven-content-switch-yearly"
						...
						<?php if ( 'content' === $settings['secondary_content_type'] ) : ?>
							...
							<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'secondary_text_content' ) ); ?>>
								<?php $this->print_text_editor( $settings['secondary_text_content'] ); ?>
							</div>
	...
	private function get_switcher_html( $settings ) {
		...
		<div class="raven-content-toggle-switcher">
			<div class="raven-content-switch-primary-label <?php echo esc_attr( $primary_is_default ); ?>">
				<h4>
			...
			<div class="raven-content-switch-secondary-label <?php echo esc_attr( $secondary_is_default ); ?>">
				<h4>
	...
	public function get_template_content( $id ) {
		...
		echo $frontend->get_builder_content_for_display( (int) $id, true ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
}
