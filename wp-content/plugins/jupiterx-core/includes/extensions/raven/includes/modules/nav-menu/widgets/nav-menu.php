...
class Nav_Menu extends Base_Widget {
	...
	protected function register_mobile_menu_section() {
		...
		$this->add_control(
			...
			[
				...
				'type' => 'color',
				'selectors' => [
					'{{WRAPPER}} .raven-nav-menu-mobile .raven-nav-menu li > a.raven-menu-item-active, {{WRAPPER}} .raven-nav-menu-mobile .raven-nav-menu li > a:active, {{WRAPPER}} .raven-nav-menu-mobile .raven-nav-menu > li.current-menu-ancestor > a.raven-menu-item' => 'background-color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		<div class="raven-nav-menu-toggle">
			...
			?>
			<div class="raven-nav-menu-toggle-button <?php echo esc_attr( $custom_svg_icon_enabled ); ?>">
				<?php
				...
				<div class="hamburger hamburger--<?php echo esc_attr( $settings['toggle_button_animation'] ); ?>">
					...
					<div class="raven-nav-menu-custom-icon">
						...
						if ( 'image/svg+xml' === get_post_mime_type( $settings['custom_toggle_button_image']['id'] ) ) {
							$custom_burger_icon = \Elementor\Icons_Manager::render_uploaded_svg_icon( $settings['custom_toggle_button_image'] );

							\Elementor\Utils::print_unescaped_internal_string( $custom_burger_icon );
						}
						?>
					</div>
					<?php
		...
		<nav <?php echo $this->get_render_attribute_string( 'mobile_menu' ); ?>>
			...
			<div class="raven-container">
				<?php \Elementor\Utils::print_unescaped_internal_string( $dropdown_html ); ?>
			</div>
		</nav>
		<?php
	}
