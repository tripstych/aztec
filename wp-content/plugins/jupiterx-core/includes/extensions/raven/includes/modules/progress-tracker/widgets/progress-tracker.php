...
use JupiterX_Core\Raven\Modules\Progress_Tracker\Module;
	...
	private function register_horizontal_style() {
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'image' ],
				'selector' => '{{WRAPPER}} .jupiterx-progress-tracker-horizontal-wrapper > .progress-indicator',
				'condition' => [
					'type' => 'horizontal',
				],
				'fields_options' => [
					'background' => [
						...
						'default' => Module::get_type_default_value(),
					],
					'color' => Utils::set_background_default_value( 'primary' ),
				],
			]
		);
