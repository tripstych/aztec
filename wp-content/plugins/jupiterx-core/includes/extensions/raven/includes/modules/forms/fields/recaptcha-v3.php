...
class Recaptcha_V3 extends Field_Base {
	...
	public function register_admin_fields( $settings ) {
		$settings->add_section( 'raven', 'raven_recaptcha_v3', [
			...
			'callback' => function() {
				echo '<p>' . sprintf(
					/* translators: 1: reCAPTCHA URL 2:reCAPTCHA title 3:reCAPTCHA Description */
					'<a href="%1$s" target="_blank">%2$s</a> %3$s',
					'https://www.google.com/recaptcha/',
					esc_html__( 'reCAPTCHA V3', 'jupiterx-core' ),
					esc_html__( 'is a free Google service that protects your website from spam and abuse.', 'jupiterx-core' )
				) . '</p>';
			},
			'fields' => [
