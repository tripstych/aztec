	...
	private function add_section_layout( $widget ) {
		...
		$widget->add_responsive_control(
			...
			[
				...
				'type' => 'media',
				'condition' => [
					'center_logo_source' => 'custom-source',
					'center_logo' => 'yes',
					'layout' => 'horizontal',
				],
				'dynamic' => [
					'active' => true,
					'categories' => [
						defined( 'ELEMENTOR_PRO_VERSION' ) ? TagsModule::IMAGE_CATEGORY : 'jupiterx_site_logo_tag',
					],
				],
			]
		);
		...
		$widget->add_responsive_control(
			...
			[
				...
				'type' => 'media',
				'condition' => [
					'side_logo_source' => 'custom-source',
					'side_logo' => 'yes',
				],
				'dynamic' => [
					'active' => true,
