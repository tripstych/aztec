...
class Controls extends Tab_Base {
	...
	protected function register_tab_controls() {
		...
		$default_shop_page_title = get_the_title( (int) $default_shop_page_id );

		$this->add_control(
			'woocommerce_shop_page_id',
			[
				'label' => esc_html__( 'Shop', 'jupiterx-core' ),
				'type' => 'raven_query',
				'query' => [
					'source'   => Control_Query::QUERY_SOURCE_PAGE,
				],
				...
				'default' => $default_shop_page_id,
				'default_title' => $default_shop_page_title,
			]
		);
