...
class Media_Gallery extends Base_Widget {
	...
	protected function render() {
		...
		if ( ! empty( $tabs ) ) {
			\Elementor\Utils::print_unescaped_internal_string( $this->render_gallery_tabs( $tabs, $settings ) );
		}

		\Elementor\Utils::print_unescaped_internal_string( $this->render_tab_contents( $items_with_category, $settings ) );
