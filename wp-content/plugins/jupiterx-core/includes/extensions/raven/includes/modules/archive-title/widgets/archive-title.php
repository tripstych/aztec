...
class Archive_Title extends Base_Widget {
	...
	public function show_in_panel() {
		$enable_archive_widgets = apply_filters( 'jupiterx_raven_enable_archive_widgets', false );

		if ( $enable_archive_widgets ) {
			return true;
		}
		...
		return 'archive' === $doc_type || 'product-archive' === $doc_type || 'page-title-bar' === $doc_type;
	}
