		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.elementor-woo-meta--view-table .product_meta .detail-container:not(:last-child)' => 'border-bottom: solid transparent calc({{SIZE}}{{UNIT}}/2);',
					'{{WRAPPER}}.elementor-woo-meta--view-table .product_meta .detail-container:not(:first-child)' => 'border-top: solid transparent calc({{SIZE}}{{UNIT}}/2);',
