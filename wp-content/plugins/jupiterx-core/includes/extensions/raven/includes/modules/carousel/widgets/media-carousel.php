...
class Media_Carousel extends Base {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'#elementor-lightbox-slideshow-{{ID}} .dialog-lightbox-close-button svg, #elementor-lightbox-slideshow-{{ID}} .elementor-swiper-button svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'#elementor-lightbox-slideshow-{{ID}} .dialog-lightbox-close-button:hover svg, #elementor-lightbox-slideshow-{{ID}} .elementor-swiper-button:hover svg' => 'fill: {{VALUE}};',
				],
			]
		);
	...
	private function add_slideshow_injections() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .raven-thumbnails-swiper .raven-carousel-image' => 'aspect-ratio: {{VALUE}}',
				],
			]
		);
	...
	private function update_controls() {
		...
		$this->update_responsive_control(
			...
			[
				'selectors' => [
					'{{WRAPPER}}.raven-skin-slideshow .raven-main-swiper' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
				'render_type' => 'template',
			]
		);
