...
class Animated_Heading extends Base_Widget {
	...
	private function register_section_style_heading() {
		...
		$this->add_control(
			...
			[
				...
				'type' => 'color',
				'global' => [
					'default' => RavenUtils::check_fresh_install() ? Global_Colors::COLOR_PRIMARY : Global_Colors::COLOR_SECONDARY,
				],
				'selectors' => [
	...
	protected function render_heading( $tag, $settings ) {
		...
		<?php elseif ( 'highlight' === $settings['heading_style'] && ! empty( $settings['highlighted_text'] ) ) : ?>
			<span class="raven-heading-dynamic-text raven-heading-text-active"><?php $this->print_unescaped_setting( 'highlighted_text' ); ?></span>
		<?php endif ?>
		</span>
		<?php if ( ! empty( $settings['after_text'] ) ) : ?>
			<span class="raven-heading-plain-text raven-heading-text-wrapper"><?php $this->print_unescaped_setting( 'after_text' ); ?></span>
		<?php endif; ?>
