...
class Module {
	 ...
	 * @var string API URL.
	 */
	private static $templates_url = 'https://blocks.jupiterx.com/wp-json/jupiterx/v1/templates/%s';
	 ...
	 * @var string API URL.
	 */
	private static $template_categories_url = 'https://blocks.jupiterx.com/wp-json/jupiterx/v1/template-categories';
