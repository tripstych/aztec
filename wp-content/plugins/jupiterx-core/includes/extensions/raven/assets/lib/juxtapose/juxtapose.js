  ...
  */
  juxtapose.makeSlider = function (element, idx) {
    ...
    slider = new juxtapose.JXSlider(
      ...
      [
        {
          src: images[0].getAttribute( 'data-lazy-src' ) ? images[0].getAttribute( 'data-lazy-src' ) : images[0].src,
          label: images[0].getAttribute('data-label'),
          credit: images[0].getAttribute('data-credit'),
          alt: images[0].alt
        },
        {
          src: images[1].getAttribute( 'data-lazy-src' ) ? images[1].getAttribute( 'data-lazy-src' ) : images[1].src,
