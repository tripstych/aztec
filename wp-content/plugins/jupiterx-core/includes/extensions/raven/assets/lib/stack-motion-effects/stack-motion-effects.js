...
;(function(window) {
	 ...
	 */
	function StackFx(options) {
		var defaultOptions = {
			stack: '.raven-stack',
			image: '.raven-stack-figure img',
			caption: '.raven-stack-caption',
			title: '.raven-stack-title',
			columnLeft: '.raven-stack-column-left',
			columnRight: '.raven-stack-column-right',
		}
		...
		this.DOM.stack = this.DOM.el.querySelector(options.stack) || '';
		this.DOM.stackItems = [].slice.call(this.DOM.stack.children);
		this.totalItems = this.DOM.stackItems.length;
		this.DOM.img = this.DOM.stack.querySelector(options.image) || '';
		this.DOM.caption = this.DOM.el.querySelector(options.caption) || '';
		this.DOM.title = this.DOM.el.querySelector(options.title) || '';
		this.DOM.columns = {left: this.DOM.el.querySelector(options.columnLeft) || '', right: this.DOM.el.querySelector(options.columnRight) || ''};
	}
	...
	PolarisFx.prototype._in = function() {
		...
		anime({
			targets: [this.DOM.el, this.DOM.el.parentElement],
			duration: 0,
			zIndex: 9
		});
