...
if ( ! class_exists( 'JupiterX_Core_Control_Panel_Helpers' ) ) {
	/**
	 * Helper functions class.
	 *
	 * @since 1.7.0
	 */
	class JupiterX_Core_Control_Panel_Helpers {
		...
		public static function include_wordpress_importer() {
			...
			if ( ! class_exists( 'JupiterX_Core_Control_Panel_WXR_Importer' ) ) {
				jupiterx_core()->load_files( [
					'control-panel-2/includes/class-logger',
					'control-panel-2/includes/class-logger-serversentevents',
					'control-panel-2/includes/class-wxr-import-info',
					'control-panel-2/includes/class-wxr-importer',
				] );
			}

			if ( ! class_exists( 'JupiterX_Core_Control_Panel_Importer' ) ) {
				jupiterx_core()->load_files( [
					'control-panel-2/includes/class-jupiterx-importer',
				] );
			}
