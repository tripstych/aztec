...
class JupiterX_Core_Control_Panel_Version_Control {
	...
	const ARTBEES_THEMES_PRODUCTS_API        = 'https://my.artbees.net/wp-json/artbees-portal-products/v1/products';
	const ARTBEES_THEMES_PRODUCT_PACKAGE_API = 'https://my.artbees.net/wp-json/artbees-portal-products/v1/products/package';
