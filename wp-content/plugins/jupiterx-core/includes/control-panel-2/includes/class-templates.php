...
class JupiterX_Core_Control_Panel_Templates {
	...
	const API_URL           = 'https://my.artbees.net/wp-json/templates/v1';
	...
	public function get_templates() {
		...
		$url = add_query_arg( $args, 'https://my.artbees.net/wp-json/templates/v1/list' );
		...
		$additional = [
			...
			'simplicity_mode' => jupiterx_get_option( 'disable_theme_default_settings', false ),
		];
