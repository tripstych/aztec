...
class RtlCssTest extends \PHPUnit_Framework_TestCase {
    ...
    public function transformsProvider() {
        return [
            [[
     ...
     * @param OutputFormat $output The output format to use.
     */
    protected function assertSample($data, $output = null) {
        if (!empty($data['skip'])) {
            $this->markTestSkipped('Not yet supported!');
        }
        $this->assertFlips($data['expected'], $data['input'], $data['should'], $output);
        if (!empty($data['reversable'])) {
            $this->assertFlips($data['input'], $data['expected'], $data['should'] . ' (reversed)', $output);
        }
    }
     ...
     */
    public function testBackgroundImage($data) {
     ...
     */
    public function testBackgroundPosition($data) {
        $output = new OutputFormat();
     ...
     */
    public function testBackground($data) {
        $output = new OutputFormat();
        $output->set('SpaceAfterRuleName', ' ');
     ...
     */
    public function testSpecial($data) {
        $output = new OutputFormat();
        $output->set('SpaceBeforeRules', ' ');
        $output->set('SpaceAfterListArgumentSeparator', array('default' => '', ',' => ' '));
        $this->assertSample($data, $output);
     ...
     */
    public function testTransformOrigin($data) {
        $output = new OutputFormat();
        $output->set('SpaceAfterRuleName', '');
        $output->set('SpaceBeforeRules', ' ');
        $output->set('SpaceAfterRules', ' ');
    ...
    /**
     * @dataProvider transformsProvider
     */
    public function testTransforms($data) {
        $output = new OutputFormat();
        $output->set('SpaceBeforeRules', ' ');
        $output->set('SpaceAfterRules', ' ');
        $output->set('SpaceAfterListArgumentSeparator', array('default' => '', ',' => ' '));
    ...
    /**
     * @dataProvider valuesNSyntaxProvider
     */
    public function testValuesNSyntax($data) {
        $output = new OutputFormat();
        $output->set('SpaceBeforeRules', ' ');
        $output->set('SpaceAfterRules', ' ');
