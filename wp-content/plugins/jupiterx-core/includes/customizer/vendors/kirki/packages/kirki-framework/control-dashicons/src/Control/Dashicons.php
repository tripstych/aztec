		...
		<div class="icons-wrapper">
			...
			<# } else { #>
				...
				var dashiconSections = {
					'admin-menu': '<?php esc_html_e( 'Admin Menu', 'jupiterx-core' ); ?>',
					'welcome-screen': '<?php esc_html_e( 'Welcome Screen', 'jupiterx-core' ); ?>',
					'post-formats': '<?php esc_html_e( 'Post Formats', 'jupiterx-core' ); ?>',
					'media': '<?php esc_html_e( 'Media', 'jupiterx-core' ); ?>',
					'image-editing': '<?php esc_html_e( 'Image Editing', 'jupiterx-core' ); ?>',
					'tinymce': 'TinyMCE',
					'posts': '<?php esc_html_e( 'Posts', 'jupiterx-core' ); ?>',
					'sorting': '<?php esc_html_e( 'Sorting', 'jupiterx-core' ); ?>',
					'social': '<?php esc_html_e( 'Social', 'jupiterx-core' ); ?>',
					'wordpress_org': 'WordPress',
					'products': '<?php esc_html_e( 'Products', 'jupiterx-core' ); ?>',
					'taxonomies': '<?php esc_html_e( 'Taxonomies', 'jupiterx-core' ); ?>',
					'widgets': '<?php esc_html_e( 'Widgets', 'jupiterx-core' ); ?>',
					'notifications': '<?php esc_html_e( 'Notifications', 'jupiterx-core' ); ?>',
					'misc': '<?php esc_html_e( 'Miscelaneous', 'jupiterx-core' ); ?>'
				};
				#>
