...
var kirkiPostMessage = {
    ...
    css: {
         ...
         * @param {mixed}  value - The value.
         * @param {string} controlType - The control-type.
         * @param {object} fieldSetting - The field settings.
         * @returns {string}
         */
        fromOutput: function( output, value, controlType, fieldSetting ) {
            var styles      = '',
                kirkiParent = window.parent.kirki,
                googleFont  = '',
                mediaQuery  = false;

            if ( Array.isArray( output.exclude ) && _.contains( output.exclude, value ) ) {
                return styles;
            }
            ...
            switch ( controlType ) {
                ...
                default:
                    ...
                    if ( ! _.isUndefined( kirkiPostMessage.fields[ controlType ] ) && _.isFunction( kirkiPostMessage.fields[ controlType ] ) ) {
                        styles += output.element + '{' + kirkiPostMessage.fields[ controlType ]( value, output, fieldSetting ) + '}';
                        break;
                    }
