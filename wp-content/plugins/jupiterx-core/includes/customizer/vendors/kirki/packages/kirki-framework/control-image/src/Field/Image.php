	...
	public function filter_control_args( $args, $wp_customize ) {
		if ( $args['settings'] === $this->args['settings'] ) {
			...
			$args['button_labels'] = wp_parse_args(
				$args['button_labels'],
				[
					'select'       => esc_html__( 'Select image', 'jupiterx-core' ),
					'change'       => esc_html__( 'Change image', 'jupiterx-core' ),
					'default'      => esc_html__( 'Default', 'jupiterx-core' ),
					'remove'       => esc_html__( 'Remove', 'jupiterx-core' ),
					'placeholder'  => esc_html__( 'No image selected', 'jupiterx-core' ),
					'frame_title'  => esc_html__( 'Select image', 'jupiterx-core' ),
					'frame_button' => esc_html__( 'Choose image', 'jupiterx-core' ),
				]
			);
