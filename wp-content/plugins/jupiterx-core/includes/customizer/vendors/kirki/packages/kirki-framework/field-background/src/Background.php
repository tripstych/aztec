		...
		new \Kirki\Field\Color(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Color', 'jupiterx-core' ),
		...
		new \Kirki\Field\Image(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Image', 'jupiterx-core' ),
		...
		new Kirki\Field\Select(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Repeat', 'jupiterx-core' ),
					'section'     => $args['section'],
					'default'     => isset( $args['default']['background-repeat'] ) ? $args['default']['background-repeat'] : '',
					'choices'     => [
						'no-repeat' => esc_html__( 'No Repeat', 'jupiterx-core' ),
						'repeat'    => esc_html__( 'Repeat All', 'jupiterx-core' ),
						'repeat-x'  => esc_html__( 'Repeat Horizontally', 'jupiterx-core' ),
						'repeat-y'  => esc_html__( 'Repeat Vertically', 'jupiterx-core' ),
					],
		...
		new Kirki\Field\Select(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Position', 'jupiterx-core' ),
					'default'     => isset( $args['default']['background-position'] ) ? $args['default']['background-position'] : '',
					'section'     => $args['section'],
					'choices'     => [
						'left top'      => esc_html__( 'Left Top', 'jupiterx-core' ),
						'left center'   => esc_html__( 'Left Center', 'jupiterx-core' ),
						'left bottom'   => esc_html__( 'Left Bottom', 'jupiterx-core' ),
						'center top'    => esc_html__( 'Center Top', 'jupiterx-core' ),
						'center center' => esc_html__( 'Center Center', 'jupiterx-core' ),
						'center bottom' => esc_html__( 'Center Bottom', 'jupiterx-core' ),
						'right top'     => esc_html__( 'Right Top', 'jupiterx-core' ),
						'right center'  => esc_html__( 'Right Center', 'jupiterx-core' ),
						'right bottom'  => esc_html__( 'Right Bottom', 'jupiterx-core' ),
					],
					'required'    => array_merge(
						$args['required'],
						[
		...
		new Kirki\Field\Radio_Buttonset(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Size', 'jupiterx-core' ),
		...
		new Kirki\Field\Radio_Buttonset(
			wp_parse_args(
				[
					...
					'description' => esc_html__( 'Background Attachment', 'jupiterx-core' ),
					'label'       => '',
					'default'     => isset( $args['default']['background-attachment'] ) ? $args['default']['background-attachment'] : '',
					'section'     => $args['section'],
					'choices'     => [
						'scroll' => esc_html__( 'Scroll', 'jupiterx-core' ),
