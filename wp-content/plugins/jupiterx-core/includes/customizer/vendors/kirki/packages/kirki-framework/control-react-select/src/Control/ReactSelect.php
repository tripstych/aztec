...
class ReactSelect extends Base {
	...
	public function to_json() {
		...
		$this->json['placeholder'] = ( $this->placeholder ) ? $this->placeholder : esc_html__( 'Select...', 'jupiterx-core' );
		...
		$this->json['messages'] = [
			...
			'maxLimitReached' => sprintf( esc_html__( 'You can only select %s items', 'jupiterx-core' ), $this->max_selection_number ),
		];
