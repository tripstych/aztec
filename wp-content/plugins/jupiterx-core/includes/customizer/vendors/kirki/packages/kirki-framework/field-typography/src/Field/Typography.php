...
class Typography extends Field {
	...
	public function init( $args = [] ) {
		...
		self::$std_variants = [
			[
				'value' => 'regular',
				'label' => __( 'Regular', 'jupiterx-core' ),
			],
			[
				'value' => 'italic',
				'label' => __( 'Italic', 'jupiterx-core' ),
			],
			[
				'value' => '700',
				'label' => __( '700', 'jupiterx-core' ),
			],
			[
				'value' => '700italic',
				'label' => __( '700 Italic', 'jupiterx-core' ),
			],
		];
		...
		self::$complete_variants = [
			...
			[
				'value' => '100',
				'label' => __( '100', 'jupiterx-core' ),
			],
			[
				'value' => '100italic',
				'label' => __( '100 Italic', 'jupiterx-core' ),
			],
			[
				'value' => '200',
				'label' => __( '200', 'jupiterx-core' ),
			],
			[
				'value' => '200italic',
				'label' => __( '200 Italic', 'jupiterx-core' ),
			],
			[
				'value' => '300',
				'label' => __( '300', 'jupiterx-core' ),
			],
			[
				'value' => '300italic',
				'label' => __( '300 Italic', 'jupiterx-core' ),
			],
			[
				'value' => '500',
				'label' => __( '500', 'jupiterx-core' ),
			],
			[
				'value' => '500italic',
				'label' => __( '500 Italic', 'jupiterx-core' ),
			],
			[
				'value' => '600',
				'label' => __( '600', 'jupiterx-core' ),
			],
			[
				'value' => '600italic',
				'label' => __( '600 Italic', 'jupiterx-core' ),
			],
			[
				'value' => '700',
				'label' => __( '700', 'jupiterx-core' ),
			...
			[
				'value' => '800',
				'label' => __( '800', 'jupiterx-core' ),
			],
			[
				'value' => '800italic',
				'label' => __( '800 Italic', 'jupiterx-core' ),
			],
			[
				'value' => '900',
				'label' => __( '900', 'jupiterx-core' ),
			],
			[
				'value' => '900italic',
				'label' => __( '900 Italic', 'jupiterx-core' ),
			],
		];
	...
	private function add_sub_fields( $args ) {
		...
		if ( isset( $args['default']['font-family'] ) ) {
			...
			new \Kirki\Field\ReactSelect(
				wp_parse_args(
					[
						'label'       => esc_html__( 'Font Family', 'jupiterx-core' ),
						'description' => '',
			...
			new \Kirki\Field\ReactSelect(
				wp_parse_args(
					[
						'label'       => esc_html__( 'Font Variant', 'jupiterx-core' ),
						'description' => '',
		...
		if ( $text_align_field_specified || $text_transform_field_specified ) {
			$group = [
				'text-align'     => [
					...
					'choices'      => [
						'initial' => esc_html__( 'Initial', 'jupiterx-core' ),
						'left'    => esc_html__( 'Left', 'jupiterx-core' ),
						'center'  => esc_html__( 'Center', 'jupiterx-core' ),
						'right'   => esc_html__( 'Right', 'jupiterx-core' ),
						'justify' => esc_html__( 'Justify', 'jupiterx-core' ),
					],
				],
				'text-transform' => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Transform', 'jupiterx-core' ),
					'is_specified' => $text_transform_field_specified,
					'choices'      => [
						'none'       => esc_html__( 'None', 'jupiterx-core' ),
						'capitalize' => esc_html__( 'Capitalize', 'jupiterx-core' ),
						'uppercase'  => esc_html__( 'Uppercase', 'jupiterx-core' ),
						'lowercase'  => esc_html__( 'Lowercase', 'jupiterx-core' ),
					],
				],
			];
		...
		if ( $line_height_field_specified || $letter_spacing_field_specified ) {
			$group = [
				'line-height'    => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Line Height', 'jupiterx-core' ),
					'is_specified' => $line_height_field_specified,
				],
				'letter-spacing' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Letter Spacing', 'jupiterx-core' ),
		...
		if ( $margin_top_field_specified || $margin_bottom_field_specified ) {
			$group = [
				'margin-top'    => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Margin Top', 'jupiterx-core' ),
					'is_specified' => $margin_top_field_specified,
				],
				'margin-bottom' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Margin Bottom', 'jupiterx-core' ),
	...
	private function get_font_family_choices() {
		...
		$choices['default'] = [
			esc_html__( 'Defaults', 'jupiterx-core' ),
			[
		...
		$choices['standard'] = [
			esc_html__( 'Standard Fonts', 'jupiterx-core' ),
			$std_fonts,
		];

		$choices['google'] = [
			esc_html__( 'Google Fonts', 'jupiterx-core' ),
