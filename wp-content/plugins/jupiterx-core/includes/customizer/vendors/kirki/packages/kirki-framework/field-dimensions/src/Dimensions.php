...
class Dimensions extends Field {
	...
	public function init( $args = array() ) {
		...
		$labels = array(
			...
			'font-size'      => esc_html__( 'Font Size', 'jupiterx-core' ),
			'font-weight'    => esc_html__( 'Font Weight', 'jupiterx-core' ),
			'line-height'    => esc_html__( 'Line Height', 'jupiterx-core' ),
			'font-style'     => esc_html__( 'Font Style', 'jupiterx-core' ),
			'letter-spacing' => esc_html__( 'Letter Spacing', 'jupiterx-core' ),
			'word-spacing'   => esc_html__( 'Word Spacing', 'jupiterx-core' ),
			...
			'size'           => esc_html__( 'Size', 'jupiterx-core' ),
			'spacing'        => esc_html__( 'Spacing', 'jupiterx-core' ),
			'width'          => esc_html__( 'Width', 'jupiterx-core' ),
			'height'         => esc_html__( 'Height', 'jupiterx-core' ),
			'invalid-value'  => esc_html__( 'Invalid Value', 'jupiterx-core' ),
		);
