...
use JupiterX_Core\enshrined\svgSanitize\data\TagInterface;
use JupiterX_Core\enshrined\svgSanitize\data\XPath;
use JupiterX_Core\enshrined\svgSanitize\ElementReference\Resolver;

/**
 * Class Sanitizer
 *
 * @package JupiterX_Core\enshrined\svgSanitize
 */
class Sanitizer
{
